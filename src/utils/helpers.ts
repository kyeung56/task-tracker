import { Task, Category, TeamMember, FilterState, PriorityColorMap, StatusColorMap, Priority, Status } from '../types';
...
export function sortTasks(tasks: Task[], sortBy: string): Task[] {
  ...
  switch (sortBy) {
    ...
    case 'priorityDesc': {
      const priorityOrderDesc: Record<Priority, number> = { critical: 0, high: 1, medium: 2, low: 3 };
...
export function filterTasks(tasks: Task[], filters: FilterState, _teamMembers: TeamMember[] = []): Task[] {
