...
// Add animation keyframes to global CSS or use Tailwind animate
...
style.textContent = `
  ...
  @keyframes drag-lift {
    ...
    100% { transform: scale(1.02) rotate(2deg); box-shadow: 0 20px 40px rgba(0,0,0,0.2); }
  }
  .dragging {
    animation: drag-lift 0.2s ease-out forwards;
    opacity: 0.9;
    z-index: 1000;
  }
`;
